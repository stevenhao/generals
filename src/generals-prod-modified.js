!function(e) {
    ...
    s.render(a.createElement(l.Provider, {
        store: n(279)
    }, a.createElement(u, null)), document.getElementById("react-container")),
    ...
    (function(e) {
        ...
        var t = n(4)
          ...
          , i = function(n, r) {
            if (this.logLevel = 4,
            this.status = !0,
            this.moduleLength = 12,
            this.dateFormat = "[hh:mm:ss]",
            "undefined" != typeof window)
                return void (this.client = !0);
            for (this.useFunctionNameBool = r !== !1,
            this.givenName = n,
            n = n || e.parent.filename.replace(/^.*[\\\/]/, ""),
            this.normalName = n,
            this.moduleName = " [" + n; this.moduleName.length < 9; )
                this.moduleName += " ";
            this.moduleName += "] ",
            this.l = {
                error: t.red,
        ...
        i.prototype.changeLength = function(e) {
            for (this.moduleName = " [" + this.normalName; this.moduleName.length < e; )
                this.moduleName += " ";
            this.moduleName += "] ",
            this.moduleLength = e
        }
        ...
        i.prototype.date = function() {
            for (var e = new Date, t = {
                hh: String("00" + e.getHours()).slice(-2),
                mm: String("00" + e.getMinutes()).slice(-2),
                ss: String("00" + e.getSeconds()).slice(-2),
                dd: String("00" + e.getDate()).slice(-2),
                yyyy: String("0000" + e.getFullYear()).slice(-4),
                MM: String("00" + (e.getMonth() + 1)).slice(-2)
            }, n = Object.keys(t), r = this.dateFormat, o = 0; o < n.length; o++)
                r = r.replace(n[o], t[n[o]]);
            return this.client ? r : this.l.date(r)
        }
        ,
        ...
        i.prototype.error = function() {
            this.logLevel >= 0 && this.print(arguments, "error")
        }
        ,
        i.prototype.warning = function() {
            this.logLevel >= 1 && this.print(arguments, "warning")
        }
        ,
        i.prototype.success = function() {
            this.logLevel >= 2 && this.print(arguments, "success")
        }
        ,
        i.prototype.log = function() {
            this.logLevel >= 3 && this.print(arguments, "log")
        }
        ,
        i.prototype.info = function() {
            this.logLevel >= 4 && this.print(arguments, "info")
        }
        ,
        i.prototype.print = function(e, t) {
            ...
            this.status) {
                ...
                for (var a = 0; a < i.length; a++)
                    "string" != typeof i[a] && "number" != typeof i[a] && (i[a] = "\n" + JSON.stringify(i[a], null, 4));
                if (this.client)
                    return void console.log(this.date() + " " + i.join(" "));
                if (this.useFunctionNameBool) {
                    var s = r.get()[2]
                      , l = o.basename(s.getFileName());
                    if (s.getFunctionName()) {
                        var u = s.getFunctionName().split(".");
                        u = u[u.length - 1];
                        var c = this.capitalise(u) + "()"
                          , p = this.l.function
                    } else
                        var c = this.capitalise(l)
                          , p = this.l.file;
                    for (; c.length < this.moduleLength; )
                        c += " ";
                    var h = this.l[t];
                    console.log(this.date() + " [" + p(c) + "] " + h(i.join(" ")))
                } else
                    console.log(this.date() + this.moduleName + this.l[t](i.join(" ")))
            }
        }
        ,
    ...
    (function(t) {
        ...
        function i() {
            ...
            var o = this._styles
              , i = o.length
              , a = l.dim.open;
            for (!d || o.indexOf("gray") === -1 && o.indexOf("grey") === -1 || (l.dim.open = ""); i--; ) {
                var s = l[o[i]];
                n = s.open + n.replace(s.closeRe, s.open) + s.close
            }
            return l.dim.open = a,
            n
        }
        ...
        var s = n(6)
          ...
          , d = "win32" === t.platform && !/^xterm/i.test({
            NODE_ENV: "production"
        }.TERM);
        d && (l.blue.open = "[94m");
        var f = function() {
            ...
            return Object.keys(l).forEach(function(t) {
                l[t].closeRe = new RegExp(s(l[t].close),"g"),
                e[t] = {
                    get: function() {
        ...
        e.exports.stripColor = u,
        e.exports.supportsColor = p
    }
    ).call(t, n(5))
}
, function(e, t) {
...
, function(e, t, n) {
    (function(e) {
        ...
        function t() {
            ...
            return e.colors.grey = e.colors.gray,
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports = function() {
            return "FORCE_COLOR"in {
                NODE_ENV: "production"
            } || !(o("no-color") || o("no-colors") || o("color=false")) && (!!(o("color") || o("colors") || o("color=true") || o("color=always")) || !(t.stdout && !t.stdout.isTTY) && ("win32" === t.platform || ("COLORTERM"in {
                NODE_ENV: "production"
            } || "dumb" !== {
                NODE_ENV: "production"
            }.TERM && !!/^screen|^xterm|^vt100|color|ansi|cygwin|linux/i.test({
                NODE_ENV: "production"
            }.TERM))))
        }()
    }
...
, function(e, t) {
    ...
    t.parse = function(e) {
        ...
        return n.map(function(e) {
            ...
            if (n) {
                ...
                return t._createParsedCallSite(c)
            }
        }).filter(function(e) {
            return !!e
        })
    ...
    t._createParsedCallSite = function(e) {
        ...
        for (var n in e) {
            var r = "get";
            "native" === n && (r = "is");
            var o = r + n.substr(0, 1).toUpperCase() + n.substr(1);
            !function(n) {
                t[o] = function() {
                    return e[n]
                }
...
, function(e, t, n) {
    (function(t) {
        ...
        var u = "win32" === t.platform
          , c = n(14)
          , p = /^([a-zA-Z]:|[\\\/]{2}[^\\\/]+[\\\/]+[^\\\/]+)?([\\\/])?([\s\S]*?)$/
          , h = /^([\s\S]*?)((?:\.{1,2}|[^\\\/]+?|)(\.[^.\/\\]*|))(?:[\\\/]*)$/
          , d = {};
        d.resolve = function() {
            for (var e = "", n = "", o = !1, i = arguments.length - 1; i >= -1; i--) {
                var l;
                if (i >= 0 ? l = arguments[i] : e ? (l = {
                    NODE_ENV: "production"
                }["=" + e],
                l && l.substr(0, 3).toLowerCase() === e.toLowerCase() + "\\" || (l = e + "\\")) : l = t.cwd(),
                !c.isString(l))
                ...
                if (l) {
                    var u = a(l)
                      ...
                      , d = u.isAbsolute
                      , f = u.tail;
                    if ((!p || !e || p.toLowerCase() === e.toLowerCase()) && (e || (e = p),
                    o || (n = f + "\\" + n,
                    o = d),
                    e && o))
                        break
        ...
        d.relative = function(e, t) {
            e = d.resolve(e),
            t = d.resolve(t);
            for (var n = e.toLowerCase(), r = t.toLowerCase(), i = o(t.split("\\")), a = o(n.split("\\")), s = o(r.split("\\")), l = Math.min(a.length, s.length), u = l, c = 0; c < l; c++)
                if (a[c] !== s[c]) {
                    u = c;
                    break
                }
            if (0 == u)
                return t;
            for (var p = [], c = u; c < a.length; c++)
                p.push("..");
            return p = p.concat(i.slice(u)),
            p.join("\\")
        }
        ,
        ...
        d.format = function(e) {
            ...
            var n = e.dir
              , r = e.base || "";
            return n ? n[n.length - 1] === d.sep ? n + r : n + d.sep + r : r
        }
        ,
        d.parse = function(e) {
            if (!c.isString(e))
        ...
        m.resolve = function() {
            for (var e = "", n = !1, o = arguments.length - 1; o >= -1 && !n; o--) {
                var i = o >= 0 ? arguments[o] : t.cwd();
                if (!c.isString(i))
                    throw new TypeError("Arguments to path.resolve must be strings");
                i && (e = i + "/" + e,
                n = "/" === i[0])
            }
            return e = r(e.split("/"), !n).join("/"),
            (n ? "/" : "") + e || "."
        }
        ,
        ...
        m.relative = function(e, t) {
            ...
            t = m.resolve(t).substr(1);
            for (var n = o(e.split("/")), r = o(t.split("/")), i = Math.min(n.length, r.length), a = i, s = 0; s < i; s++)
                if (n[s] !== r[s]) {
                    a = s;
                    break
                }
            for (var l = [], s = a; s < n.length; s++)
                l.push("..");
...
, function(e, t, n) {
    (function(e, r) {
        ...
        function l(e, n, r) {
            ...
            if (S(n) && (g = " " + RegExp.prototype.toString.call(n)),
            C(n) && (g = " " + Date.prototype.toUTCString.call(n)),
            _(n) && (g = " " + c(n)),
            ...
            e.seen.push(n);
            var A;
            return A = y ? p(e, n, r, m, a) : a.map(function(t) {
                return h(e, n, r, m, t, y)
            }),
            e.seen.pop(),
            d(A, g, T)
        }
        ...
        function p(e, t, n, r, o) {
            for (var i = [], a = 0, s = t.length; a < s; ++a)
                N(t, String(a)) ? i.push(h(e, t, n, r, String(a), !0)) : i.push("");
        ...
        function h(e, t, n, r, o, i) {
            ...
            N(r, o) || (a = "[" + o + "]"),
            s || (e.seen.indexOf(u.value) < 0 ? (s = v(n) ? l(e, u.value, null) : l(e, u.value, n - 1),
            s.indexOf("\n") > -1 && (s = i ? s.split("\n").map(function(e) {
                return "  " + e
            }).join("\n").substr(2) : "\n" + s.split("\n").map(function(e) {
                return "   " + e
        ...
        function S(e) {
            return A(e) && "[object RegExp]" === M(e)
        }
        function A(e) {
            return "object" == typeof e && null !== e
        }
        function C(e) {
            return A(e) && "[object Date]" === M(e)
        }
        function _(e) {
            return A(e) && ("[object Error]" === M(e) || e instanceof Error)
        }
        function P(e) {
        ...
        t.format = function(e) {
            ...
            for (var n = 1, r = arguments, i = r.length, a = String(e).replace(I, function(e) {
                if ("%%" === e)
                    return "%";
                if (n >= i)
                    return e;
...
, function(e, t) {
    ...
    e.exports = {
        ...
        NOT_BOT_KEY: "l1I1lII1",
        BOT_TAG: "[Bot]",
        DEFAULT_MAP_SIZE_OPTION: .5,
        DEFAULT_CITY_DENSITY_OPTION: .5,
        DEFAULT_MOUNTAIN_DENSITY_OPTION: .5
    }
}
, function(e, t, n) {
    "use strict";
      ...
      , h = r.createClass({
        ...
        render: function() {
            ...
            return e.page === i.PAGE_MAIN_MENU ? t = r.createElement(s, {
                key: "main-menu"
            }) : e.page === i.PAGE_QUEUE ? t = !e.queue.isTeamQueue && a.isCustomGame(e.queue.queue_id) ? r.createElement(u, {
                key: "custom-queue"
            }) : r.createElement(l, {
                key: "queue"
            }) : e.page === i.PAGE_GAME ? t = r.createElement(c, {
                key: "game-page"
...
, function(e, t, n) {
    ...
    function l(e, t, n) {
        ...
        Array.isArray(l) ? u(l, o, n, v.thatReturnsArgument) : null != l && (m.isValidElement(l) && (l = m.cloneAndReplaceKey(l, i + (!l.key || t && t.key === l.key ? "" : r(l.key) + "/") + n)),
        o.push(l))
    }
...
, function(e, t, n) {
    ...
    c.createElement = function(e, t, n) {
        var i, l = {}, p = null, h = null, d = null, f = null;
        if (null != t) {
            r(t) && (h = t.ref),
            o(t) && (p = "" + t.key),
            ...
            for (i in t)
                s.call(t, i) && !u.hasOwnProperty(i) && (l[i] = t[i])
        }
        ...
        return c(e, p, h, d, f, a.current, l)
    }
    ,
    ...
    c.cloneElement = function(e, t, n) {
        var l, p = i({}, e.props), h = e.key, d = e.ref, f = e._self, m = e._source, v = e._owner;
        if (null != t) {
            r(t) && (d = t.ref,
            v = a.current),
            o(t) && (h = "" + t.key);
            ...
            for (l in t)
                s.call(t, l) && !u.hasOwnProperty(l) && (void 0 === t[l] && void 0 !== g ? p[l] = g[l] : p[l] = t[l])
        }
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        S.hasOwnProperty(t) && ("OVERRIDE_BASE" !== n ? h("73", t) : void 0),
                ...
                if (t.hasOwnProperty(i) && i !== y) {
                    ...
                    E.hasOwnProperty(i))
                        ...
                        if (d)
                            ...
                            var f = T[i];
                            !c || "DEFINE_MANY_MERGED" !== f && "DEFINE_MANY" !== f ? h("77", f, i) : void 0,
                            "DEFINE_MANY_MERGED" === f ? n[i] = l(n[i], a) : "DEFINE_MANY" === f && (n[i] = u(n[i], a))
                        } else
                            n[i] = a
                    }
                }
      ...
      , p = function(e) {
        function t() {
            ...
            for (var s = arguments.length, u = Array(s), p = 0; p < s; p++)
                u[p] = arguments[p];
            return n = i = o(this, e.call.apply(e, [this].concat(u))),
      ...
      , c = function(e) {
        function t() {
            ...
            i._handleDoneAppearing = function(e) {
                ...
                var n;
                n = l.getChildMapping(i.props.children),
      ...
      , i = (n(25),
    {
        ...
        injectDOMPropertyConfig: function(e) {
            ...
            for (var p in n) {
                ...
                c.hasOwnProperty(p) && (f.mutationMethod = c[p]),
                s.properties[p] = f
            }
        }
    })
...
, function(e, t, n) {
    ...
    function r() {
        ...
        y.DOMProperty.injectDOMPropertyConfig(T),
...
, function(e, t, n) {
    ...
    function u(e, t, n, r) {
        var o, u;
        if (T ? o = i(e) : M ? s(e, n) && (o = P.compositionEnd) : a(e, n) && (o = P.compositionStart),
        !o)
            return null;
        A && (M || o !== P.compositionStart ? o === P.compositionEnd && M && (u = M.getData()) : M = m.getPooled(r));
    ...
    var S = f.canUseDOM && "TextEvent"in window && !E && !r()
      , A = f.canUseDOM && (!T || E && E > 8 && E <= 11)
      , C = 32
...
, function(e, t, n) {
    ...
    function o(e, t, n) {
        u.eventNameDispatchConfigs.hasOwnProperty(n) ? a("99", n) : void 0,
    ...
    function i(e, t, n) {
        u.registrationNameModules[e] ? a("100", e) : void 0,
        ...
        injectEventPluginsByName: function(e) {
            ...
            for (var n in e)
                if (e.hasOwnProperty(n)) {
                    var o = e[n];
                    l.hasOwnProperty(n) && l[n] === o || (l[n] ? a("102", n) : void 0,
                    l[n] = o,
                    t = !0)
                }
            t && r()
...
, function(e, t, n) {
    ...
    function r(e, t, n, r) {
        ...
        return l ? this.isDefaultPrevented = a.thatReturnsTrue : this.isDefaultPrevented = a.thatReturnsFalse,
...
, function(e, t, n) {
    ...
    var y = n(59)
      ...
      , N = null
      , I = !1;
    T.canUseDOM && (I = _("change") && (!document.documentMode || document.documentMode > 8));
    var O = !1;
    ...
    var R = {
      ...
      , D = {
        ...
        extractEvents: function(e, t, n, o) {
            ...
            if (r(s) ? I ? i = l : a = u : P(s) ? O ? i = d : (i = m,
            a = f) : v(s) && (i = g),
            i) {
                var c = i(e, t);
                if (c) {
                    var p = A.getPooled(w.change, c, n, o);
...
, function(e, t, n) {
    ...
    function l(e) {
        return r(),
        E.isBatchingUpdates ? (g.push(e),
        void (null == e._updateBatchNumber && (e._updateBatchNumber = y + 1))) : void E.batchedUpdates(l, e)
    }
    function u(e, t) {
...
, function(e, t, n) {
    "use strict";
    var r, o = n(65), i = n(94), a = /^[ \r\n\t\f]/, s = /<(!--|link|noscript|meta|script|style)[ \r\n\t\f\/>]/, l = n(96), u = l(function(e, t) {
...
, function(e, t, n) {
    ...
    function o(e, t) {
        t && (z[e._tag] && (null != t.children || null != t.dangerouslySetInnerHTML ? m("137", e._tag, e._currentElement._owner ? " Check the render method of " + e._currentElement._owner.getName() + "." : "") : void 0),
        null != t.dangerouslySetInnerHTML && (null != t.children ? m("60") : void 0,
        "object" == typeof t.dangerouslySetInnerHTML && j in t.dangerouslySetInnerHTML ? void 0 : m("61")),
    ...
    function c() {
        ...
        case "audio":
            ...
            for (var n in q)
                q.hasOwnProperty(n) && e._wrapperState.listeners.push(_.trapBubbledEvent(n, q[n], t));
            break;
        case "source":
    ...
    function h(e) {
        J.call(Q, e) || (X.test(e) ? void 0 : m("65", e),
        Q[e] = !0)
    }
    function d(e, t) {
    ...
    f.Mixin = {
        mountComponent: function(e, t, n, r) {
            ...
            p = n._tag),
            (null == a || a === T.svg && "foreignobject" === p) && (a = T.html),
            a === T.html && ("svg" === this._tag ? a = T.svg : "math" === this._tag && (a = T.mathml)),
            ...
            if (e.useCreateElement) {
                ...
                h = !A && K[this._tag] ? E + "/>" : E + ">" + A + "</" + this._currentElement.type + ">"
            }
            switch (this._tag) {
            case "input":
        ...
        _createOpenTagMarkupAndPutListeners: function(e, t) {
            ...
            return e.renderToStaticMarkup ? n : (this._hostParent || (n += " " + S.createMarkupForRoot()),
            ...
            for (r in e)
                if (!t.hasOwnProperty(r) && e.hasOwnProperty(r) && null != e[r])
                    if (r === F) {
                        ...
                        U.hasOwnProperty(r) ? e[r] && B(this, r) : d(this._tag, e) ? V.hasOwnProperty(r) || S.deleteValueForAttribute(L(this), r) : (E.properties[r] || E.isCustomAttribute(r)) && S.deleteValueForProperty(L(this), r);
            for (r in t) {
                var l = t[r]
                  , u = r === F ? this._previousStyleCopy : null != e ? e[r] : void 0;
                if (t.hasOwnProperty(r) && l !== u && (null != l || null != u))
                    if (r === F)
                        if (l ? l = this._previousStyleCopy = v({}, l) : this._previousStyleCopy = null,
                        u) {
                            for (o in u)
                                !u.hasOwnProperty(o) || l && l.hasOwnProperty(o) || (a = a || {},
                                a[o] = "");
                            for (o in l)
                                l.hasOwnProperty(o) && u[o] !== l[o] && (a = a || {},
                                a[o] = l[o])
                        } else
                            a = l;
                    else if (U.hasOwnProperty(r))
                        l ? i(this, r, l, n) : u && B(this, r);
                    else if (d(this._tag, t))
                        V.hasOwnProperty(r) || S.setValueForAttribute(L(this), r, l);
...
, function(e, t, n) {
    "use strict";
    function r(e) {
        return !!u.hasOwnProperty(e) || !l.hasOwnProperty(e) && (s.test(e) ? (u[e] = !0,
        !0) : (l[e] = !0,
        !1))
    }
    function o(e, t) {
...
, function(e, t, n) {
    ...
    var o, i = n(21), a = n(60), s = n(118), l = n(88), u = n(119), c = n(82), p = {}, h = !1, d = 0, f = {
        topAbort: "abort",
        ...
        listenTo: function(e, t) {
            for (var n = t, o = r(n), i = a.registrationNameDependencies[e], s = 0; s < i.length; s++) {
                ...
                o.topBlur = !0,
                o.topFocus = !0) : f.hasOwnProperty(l) && v.ReactEventListener.trapBubbledEvent(l, f[l], n),
                o[l] = !0)
            }
        },
...
, function(e, t, n) {
    ...
    function o(e) {
        ...
        if ("radio" === t.type && null != o) {
            for (var a = u.getNodeFromInstance(this), s = a; s.parentNode; )
                s = s.parentNode;
    ...
    !1)
      , u = {
        mountWrapper: function(e, t, n) {
            ...
            if (null != o) {
                var l;
                if (l = null != t.value ? t.value + "" : r(t.children),
                a = !1,
                Array.isArray(o)) {
        ...
        mountWrapper: function(e, t) {
            ...
            if (null == n) {
                var a = t.defaultValue
                  , l = t.children;
                null != l && (null != a ? i("92") : void 0,
                Array.isArray(l) && (l.length <= 1 ? void 0 : i("93"),
                l = l[0]),
                a = "" + l),
                null == a && (a = ""),
                r = a
            ...
            mountChildren: function(e, t, n) {
                ...
                for (var a in r)
                    if (r.hasOwnProperty(a)) {
                        var s = r[a]
                          , l = 0
                          , u = h.mountComponent(s, t, this, this._hostContainerInfo, n, l);
                        s._mountIndex = i++,
                        o.push(u)
                    }
                return o
                ...
                if (a || r) {
                    ...
                    for (s in a)
                        if (a.hasOwnProperty(s)) {
                            var v = r && r[s]
                              , g = a[s];
                            v === g ? (c = l(c, this.moveChild(v, m, p, d)),
                            d = Math.max(v._mountIndex, d),
                            v._mountIndex = p) : (v && (d = Math.max(v._mountIndex, d)),
                            c = l(c, this._mountChildAtIndex(g, i[f], m, p, t, n)),
                            f++),
                            p++,
                            m = h.getHostNode(g)
                        }
                    for (s in o)
                        o.hasOwnProperty(s) && (c = l(c, this._unmountChild(r[s], o[s])));
                    c && u(this, c),
...
, function(e, t, n) {
    ...
    function i(e, t) {
        ...
        if (null === e || e === !1)
            ...
            "string" == typeof e || "number" == typeof e ? n = c.createInstanceForText(e) : a("131", typeof e);
    ...
    var T = 1
      , E = {
        ...
        mountComponent: function(e, t, n, l) {
            ...
            this._hostParent = t,
            this._hostContainerInfo = n;
            var c, p = this._currentElement.props, h = this._processContext(l), f = this._currentElement.type, m = e.getUpdateQueue(), g = i(f), y = this._constructComponent(g, p, h, m);
            g || null != y && null != y.render ? a(f) ? this._compositeType = b.PureClass : this._compositeType = b.ImpureClass : (c = y,
            o(f, c),
            null === y || y === !1 || u.isValidElement(y) ? void 0 : s("105", f.displayName || f.name || "Component"),
            y = new r(f),
            ...
            "object" != typeof E || Array.isArray(E) ? s("106", this.getName() || "ReactCompositeComponent") : void 0,
            this._pendingStateQueue = null,
            this._pendingReplaceState = !1,
            this._pendingForceUpdate = !1;
            var S;
            return S = y.unstable_handleError ? this.performInitialMountWithErrorHandling(c, t, n, e, l) : this.performInitialMount(c, t, n, e, l),
        ...
        updateComponent: function(e, t, n, r, o) {
            ...
            var u = t.props
              , c = n.props;
            t !== n && (l = !0),
            l && i.componentWillReceiveProps && i.componentWillReceiveProps(c, a);
            var p = this._processPendingState(c, a)
              , h = !0;
            this._pendingForceUpdate || (i.shouldComponentUpdate ? h = i.shouldComponentUpdate(c, p, a) : this._compositeType === b.PureClass && (h = !g(u, c) || !g(i.state, p))),
            this._updateBatchNumber = null,
        ...
        _renderValidatedComponent: function() {
            ...
            if (this._compositeType !== b.StatelessFunctional) {
                ...
                e = this._renderValidatedComponentWithoutOwnerOrContext();
            return null === e || e === !1 || u.isValidElement(e) ? void 0 : s("109", this.getName() || "ReactCompositeComponent"),
            e
        },
...
, 31, 33, function(e, t, n) {
    ...
    function s(e) {
        var t, n = _.getDisplayName(e), r = _.getElement(e), o = _.getOwnerID(e);
        return o && (t = _.getDisplayName(o)),
        i(n, r && r._source, t)
    }
    var l, u, c, p, h, d, f, m = n(24), v = n(27), g = (n(25),
    n(28),
...
, function(e, t, n) {
    "use strict";
    function r(e, t) {
        "_hostNode"in e ? void 0 : l("33"),
        "_hostNode"in t ? void 0 : l("33");
    ...
    function o(e, t) {
        "_hostNode"in e ? void 0 : l("35"),
        "_hostNode"in t ? void 0 : l("35");
        for (; t; ) {
            if (t === e)
                return !0;
            t = t._hostParent
...
, function(e, t, n) {
    ...
    o(u.prototype, {
        mountComponent: function(e, t, n, r) {
            ...
            return e.renderToStaticMarkup ? f : "<!--" + i + "-->" + f + "<!--" + u + "-->"
        },
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        if (!g || !h(g, n)) {
            g = n;
            var o = u.getPooled(f.select, v, e, t);
    ...
    var C = {}
      , _ = {
        ...
        extractEvents: function(e, t, n, r) {
            ...
            return s.accumulateTwoPhaseDispatches(l),
            l
        },
        didPutListener: function(e, t, n) {
...
, function(e, t, n) {
    ...
    function a(e, t, n, r, o) {
        ...
        U._mountImageIntoNode(l, t, e, r, n)
    }
    function s(e, t, n, r) {
    ...
    var U = {
        ...
        _updateRootComponent: function(e, t, n, r, o) {
            return U.scrollMonitor(r, function() {
                _.enqueueElementInternal(e, t, n),
                o && _.enqueueCallbackInternal(e, o)
            }),
            e
        },
        ...
        renderSubtreeIntoContainer: function(e, t, n, r) {
            return null != e && S.has(e) ? void 0 : d("38"),
            U._renderSubtreeIntoContainer(e, t, n, r)
        },
        _renderSubtreeIntoContainer: function(e, t, n, r) {
            _.validateCallback(r, "ReactDOM.render"),
            ...
            var y = o(n)
              ...
              , T = u(n)
              , E = b && !c && !T
              , A = U._renderNewRootComponent(s, n, E, a)._renderedComponent.getPublicInstance();
            return r && r.call(A),
            A
        },
    ...
    var r = n(20)
      ...
      , u = r.createClass({
        ...
        transition: function(e, t, n) {
            ...
            i.addClass(r, s),
            this.queueClassAndNode(l, r),
            n ? (u = setTimeout(c, n),
            this.transitionTimeouts.push(u)) : a.addEndEventListener(r, c)
        },
...
, function(e, t, n) {
    ...
    e.exports = {
        ...
        userIdsFrom2v2Id: function(e) {
            var t = e.indexOf(o);
            if (!(t < 0))
                return [e.substring(0, t), e.substring(t + o.length)]
        },
    ...
    n(224))
      ...
      , M = r.createClass({
        ...
        componentDidMount: function() {
            s.username && (this.state.username = s.username,
            this.setState({
                username: s.username
            }));
            var e = this;
            setTimeout(function() {
                p.doWhenVisible(function() {
                    v.isPrivateURL() ? this.props.joinPrivateGame.bind(this)(v.getPrivateID()) : v.isReplayURL() ? a.getReplay(v.getReplayID(), f.startReplay) : v.isTeamURL() && this.props.joinTeam.bind(this)(v.getTeamID())
                }
                .bind(e))
            }, m.getState().game.playAgainUrl ? 400 : 0)
        },
        showUsernameModal: function(e) {
            this.setState({
                showUsernameModal: e
            })
        },
        showNoUsernameChange: function(e) {
            this.setState({
                showNoUsernameChange: e
            })
        },
        onPlayClicked: function() {
            return s.completed_tutorial ? a.isConnected() ? void this.setState({
                showGameModes: !0
            }) : void this.setState({
                showNotConnected: !0
        ...
        onLeaderboardClicked: function() {
            ...
            a.updateStarsAndRank(),
            a.getLeaderboard("duel"),
            a.getLeaderboard("ffa")
        },
        ...
        openReplay: function(e) {
            A.changeURL("/replays/" + encodeURIComponent(e)),
            a.getReplay(e, f.startReplay)
        },
        replayRows: function() {
            var e = this
              , t = m.getState().menu.replays || [];
        ...
        onPrivateClicked: function() {
            this.props.joinPrivateGame.bind(this)(u.randomString(l.CUSTOM_GAME_URL_LENGTH))
        },
        on2v2Clicked: function() {
            this.props.joinTeam.bind(this)(u.randomString(l.CUSTOM_GAME_URL_LENGTH))
        },
        ...
        render: function() {
            return r.createElement("div", {
                ...
                onClick: s.GIO_CACHED_USERNAME && !this.props.is_supporter ? this.showNoUsernameChange.bind(this, !0) : this.showUsernameModal.bind(this, !0)
                ...
                className: "bold"
            }, "WASD"), " to move armies."), y ? null : r.createElement("p", {
                style: {
                    fontSize: "14px"
                }
            }, "[Spacebar] to deselect, [Q] to clear moves, [E] to undo moves."), y ? null : r.createElement("p", {
                style: {
                    fontSize: "14px"
                }
            ...
            }, "2 clicks = move 50%")), r.createElement(h, {
                ...
                width: 728,
                height: 90
            })), this.state.showUsernameModal ? r.createElement(P, {
                close: this.showUsernameModal.bind(this, !1),
                setUsername: a.setUsername,
                is_supporter: this.props.is_supporter
            }) : null, this.state.showGameModes ? r.createElement(_, {
                onClose: this.closeGameModes
            }, r.createElement("center", null, !this.props.is_supporter && g.adBlockEnabled() ? r.createElement("p", {
                style: {
                    padding: "5px",
                    marginBottom: "15px",
                    backgroundColor: "#eee"
            ...
            }, "Up to ", l.PLAYER_CAP, " players battle until only 1 remains."), r.createElement("button", {
                className: "inverted",
            ...
            }, "Custom"), r.createElement("p", null, "Create a private game."))) : null, this.state.showLeaderboard ? r.createElement(T, {
                allLeaderboards: m.getState().menu.leaderboards,
                data2v2Teammates: m.getState().menu.data2v2Teammates,
                playerRanks: this.props.rank,
                playerUsername: this.state.username,
                getLeaderboard: a.getLeaderboard,
                get2v2Teammates: a.get2v2Teammates,
                hideLeaderboards: this.hideLeaderboards
            }) : null, this.state.showOption ? r.createElement(E, {
                hideOptions: this.hideOptions
            }) : null, this.state.showReplayList ? r.createElement(_, {
                id: "replays"
            }, r.createElement("h1", {
                className: "center-horizontal",
                style: {
            ...
            }, "Exit")) : null, this.state.showChangingServers ? r.createElement(_, null, r.createElement("h2", {
                style: {
                    color: "black",
                    textAlign: "center",
                    margin: "10px"
            ...
            })) : null, this.state.showNoUsernameChange ? r.createElement(_, {
                onClose: this.showNoUsernameChange.bind(this, !1)
            }, r.createElement("p", null, r.createElement("a", {
                href: "/support",
                target: "_blank",
                className: "dark"
            }, "Become a Supporter"), " to change your username.")) : null))
        }
    });
    e.exports = o.connect(function(e) {
        return Object.assign({}, e.account, e.menu)
    }, function(e) {
        return {
            onPlayFFA: function() {
                a.play(),
            ...
            joinPrivateGame: function(t) {
                u.isCustomGame(t) || alert('"' + t + '" is not an allowed custom game id.'),
                a.playPrivate(t),
                e(i.play(t))
            },
            closeRemovedFrom2v2: function() {
                e(i.closeRemovedFrom2v2())
            }
        }
    })(M)
}
            ...
            var n = "Connect(" + s(e) + ")"
              , r = function(r) {
                ...
                s.prototype.trySubscribe = function() {
                    u && !this.unsubscribe && (this.unsubscribe = this.store.subscribe(this.handleChange.bind(this)),
                    this.handleChange())
                }
                ,
                ...
                s.prototype.getWrappedInstance = function() {
                    return (0,
                    A.default)(S, "To access the wrapped instance, you need to specify { withRef: true } as the fourth argument of the connect() call."),
                ...
                s.prototype.render = function() {
                    ...
                    var a = !0
                      , s = !0;
                    b && i && (a = n || t && this.doStatePropsDependOnOwnProps,
                    s = t && this.doDispatchPropsDependOnOwnProps);
                    var l = !1
                      , u = !1;
                    r ? l = !0 : a && (l = this.updateStatePropsIfNeeded()),
                    s && (u = this.updateDispatchPropsIfNeeded());
                    var h = !0;
                    return h = !!(l || u || t) && this.updateMergedPropsIfNeeded(),
                    !h && i ? i : (S ? this.renderedElement = (0,
                    p.createElement)(e, c({}, this.mergedProps, {
                        ref: "wrappedInstance"
...
, function(e, t, n) {
    function r(e) {
        return null == e ? void 0 === e ? l : s : (e = Object(e),
        u && u in e ? i(e) : a(e))
    }
    var o = n(205)
      , i = n(208)
    ...
    function o() {
        ...
        return function(e) {
            return function(n, r, o) {
                ...
                l = s.default.apply(void 0, u)(a.dispatch),
                i({}, a, {
                    dispatch: l
                })
            }
...
, function(e, t) {
    ...
    var p = "MainMenu_play"
      ...
      , g = "MainMenu_2v2teammates"
      , y = "MainMenu_closeRemovedFrom2v2"
    ...
    e.exports = {
        ...
        ACTION_SET_2V2_TEAMMATES: g,
        ACTION_CLOSE_REMOVED_FROM_2V2: y,
...
, function(e, t, n) {
    ...
    try {
        if (D.hasOwnProperty("stars")) {
            ...
            for (var F = JSON.parse(D.stars), j = Object.keys(F), V = 0; V < j.length; V++)
                logger.log(j[V] + ": " + F[j[V]]);
            console.groupEnd(),
            k.dispatch(x.stars(F))
        }
        if (D.hasOwnProperty("rank")) {
            console.group("Found Cached Rank");
            for (var W = JSON.parse(D.rank), j = Object.keys(W), V = 0; V < j.length; V++)
                logger.log(j[V] + ": " + W[j[V]]);
            console.groupEnd(),
            k.dispatch(x.rank(W))
        }
    } catch (e) {
    ...
    K.on("connect", function() {
        ...
        Y = !0,
        i(),
        D.GIO_CACHED_USERNAME && k.dispatch(R.setUsername(D.GIO_CACHED_USERNAME)),
        K.emit("get_username", H, function(e) {
            console.log("username: " + e),
            e && (k.dispatch(R.setUsername(e)),
            D.GIO_CACHED_USERNAME = e)
        }),
        void K.emit("is_supporter", H, function(e) {
            logger.log("Player is supporter: " + e),
            k.dispatch(R.setIsSupporter(e))
        }))
    }),
    K.on("disconnect", function() {
        logger.log("Disconnected from server."),
        k.getState().page !== B.PAGE_GAME || k.getState().game.isLocalGame || alert("Disconnected from server. Please refresh the page.")
    }),
    ...
    K.on("leaderboard", function(e) {
        D["leaderboard:" + e.ladder] = JSON.stringify(e),
        k.dispatch(x.leaderboard(e))
    }),
    K.on("2v2_teammates", function(e) {
        D["2v2_teammates"] = JSON.stringify(e),
        k.dispatch(x.set2v2Teammates(e))
    }),
...
, function(e, t, n) {
    function r(e, t) {
        ...
        e = void 0),
        t = t || {};
        var n, r = i(e), a = r.source, c = r.id, p = r.path, h = u[c] && p in u[c].nsps, d = t.forceNew || t["force new connection"] || !1 === t.multiplex || h;
        return d ? (l("ignoring socket cache for %s", a),
        n = s(a, t)) : (u[c] || (l("new io instance for %s", a),
        u[c] = s(a, t)),
        n = u[c]),
...
, [358, 230], [359, 231], function(e, t) {
    ...
    function o(e) {
        return i(e, u, "day") || i(e, l, "hour") || i(e, s, "minute") || i(e, a, "second") || e + " ms"
    }
    function i(e, t, n) {
        if (!(e < t))
...
, function(e, t, n) {
    ...
    function s(e) {
        ...
        return e.charAt(++r) && (n = l(n, e.substr(r))),
        ...
        (function() {
            function i(e, t) {
                    ...
                    if ("bug-string-char-index" == e)
                        ...
                        if ("json-stringify" == e) {
                            ...
                            if (c) {
                                ...
                                try {
                                    c = "0" === u(0) && "0" === u(new r) && '""' == u(new o) && u(y) === v && u(v) === v && u() === v && "1" === u(a) && "[1]" == u([a]) && "[null]" == u([v]) && "null" == u(null) && "[null,null,null]" == u([v, y, null]) && u({
                                        a: [a, !0, !1, null, "\0\b\n\f\r\t"]
                ...
                var r = e.Number || u.Number
                  ...
                  , a = e.Object || u.Object
                  , l = e.Date || u.Date
                  , c = e.SyntaxError || u.SyntaxError
                  , p = e.TypeError || u.TypeError
                  , h = e.Math || u.Math
                  , d = e.JSON || u.JSON;
                "object" == typeof d && d && (t.stringify = d.stringify,
                t.parse = d.parse);
                var f, m, v, g = a.prototype, y = g.toString, b = new l(-0xc782b5b800cec);
                try {
                ...
                if (!n("json")) {
                    ...
                    m = function(e, t) {
                        ...
                        m = function(e, t) {
                            var n, o, i = y.call(e) == T, a = !i && "function" != typeof e.constructor && s[typeof e.hasOwnProperty] && e.hasOwnProperty || f;
                            for (n in e)
                    ...
                    !n("json-stringify")) {
                        var x = {
                          ...
                          , D = function(e, t, n, r, o, i, a) {
                            var s, l, u, c, h, d, g, b, T, P, M, x, N, O, B, L;
                            try {
                                s = t[e]
                            } catch (e) {}
                            if ("object" == typeof s && s)
                                if (l = y.call(s),
                                l != E || f.call(s, "toJSON"))
                                    "function" == typeof s.toJSON && (l != S && l != A && l != C || f.call(s, "toJSON")) && (s = s.toJSON(e));
                                else if (s > -1 / 0 && s < 1 / 0) {
                                    if (k) {
                                        for (h = w(s / 864e5),
                                        u = w(h / 365.2425) + 1970 - 1; k(u + 1, 0) <= h; u++)
                                            ;
                                        for (c = w((h - k(u, 0)) / 30.42); k(u, c + 1) <= h; c++)
                                            ;
                                        h = 1 + h - k(u, c),
                                    ...
                                    s = (u <= 0 || u >= 1e4 ? (u < 0 ? "-" : "+") + I(6, u < 0 ? -u : u) : I(4, u)) + "-" + I(2, c + 1) + "-" + I(2, h) + "T" + I(2, g) + ":" + I(2, b) + ":" + I(2, T) + "." + I(3, P) + "Z"
                                } else
                                    s = null;
                            if (n && (s = n.call(t, e, s)),
                            null === s)
                        ...
                        t.stringify = function(e, t, n) {
                            ...
                            if (s[typeof t] && t)
                                if ((a = y.call(t)) == T)
                                    ...
                                    i = {};
                                    for (var l, u = 0, c = t.length; u < c; l = t[u++],
                                    a = y.call(l),
                                    (a == A || a == S) && (i[l] = 1))
                                        ;
                                }
                    ...
                    if (!n("json-parse")) {
                        var B, L, G = o.fromCharCode, U = {
                            ...
                            for (var e, t, n, r, o, i = L, a = i.length; B < a; )
            ...
            var a = n(237)
              ...
              , c = l && s[typeof e] && e && !e.nodeType && "object" == typeof o && o;
            if (!c || c.global !== c && c.window !== c && c.self !== c || (u = c),
            l && !a)
                i(u, l);
            else {
                var p = u.JSON
        ...
        t.removeBlobs = function(t, n) {
            function i(t, l, u) {
                ...
                if (e.Blob && t instanceof Blob || e.File && t instanceof File) {
                    ...
                    c.onload = function() {
                        u ? u[l] = this.result : s = this.result,
                        --a || n(s)
                    }
                    ,
...
, function(e, t, n) {
    ...
    var o = n(243)
      ...
      , l = n(275)
      , u = n(276)
      , c = n(229)("socket.io-client:manager")
      , p = n(270)
      , h = n(278)
    ...
    r.prototype.onopen = function() {
        ...
        this.emit("open");
        var e = this.engine;
        this.subs.push(l(e, "data", u(this, "ondata"))),
        this.subs.push(l(e, "ping", u(this, "onping"))),
        this.subs.push(l(e, "pong", u(this, "onpong"))),
        this.subs.push(l(e, "error", u(this, "onerror"))),
        this.subs.push(l(e, "close", u(this, "onclose"))),
...
, function(e, t, n) {
    (function(t) {
        function r(e, n) {
            ...
            n.port = e.port,
            e.query && (n.query = e.query)) : n.host && (n.hostname = c(n.host).host),
        ...
        var i = n(246)
          , a = n(260)
          , s = n(264)("engine.io-client:socket")
          , l = n(270)
          , u = n(252)
          , c = n(228)
          , p = n(271)
        ...
        r.prototype.probe = function(e) {
            ...
            function l(e) {
                c && e.name !== c.name && (s('"%s" works - aborting "%s"', e.name, c.name),
                n())
            }
            function u() {
...
, function(e, t, n) {
    (function(e) {
        function r(t) {
            var n, r = !1, s = !1, l = !1 !== t.jsonp;
            if (e.location) {
                var u = "https:" === location.protocol
                  , c = location.port;
                c || (c = u ? 443 : 80),
                r = t.hostname !== location.hostname || c !== t.port,
                s = t.secure !== u
            }
            if (t.xdomain = r,
            t.xscheme = s,
...
, function(e, t, n) {
    (function(t) {
        ...
        var s = n(247)
          ...
          , u = n(260)
          , c = n(262)
          , p = n(264)("engine.io-client:polling-xhr");
        e.exports = o,
        e.exports.Request = i,
        c(o, l),
...
, function(e, t, n) {
    ...
    var o = n(251)
      ...
      , s = n(262)
      , l = n(263)
      , u = n(264)("engine.io-client:polling");
    e.exports = r;
    var c = function() {
        var e = n(247)
          , t = new e({
...
, function(e, t, n) {
    (function(e) {
        ...
        var u, c = n(253), p = n(254), h = n(255), d = n(256), f = n(257);
        e && e.ArrayBuffer && (u = n(258));
        ...
        t.encodePacket = function(t, n, i, s) {
            ...
            if (e.ArrayBuffer && l instanceof ArrayBuffer)
                return o(t, n, s);
            if (E && l instanceof e.Blob)
                return a(t, n, s);
            if (l && l.base64)
                return r(t, s);
            var u = y[t.type];
            return void 0 !== t.data && (u += i ? f.encode(String(t.data)) : String(t.data)),
            s("" + u)
        }
        ,
        t.encodeBase64Packet = function(n, r) {
            ...
            try {
                ...
                for (var s = new Uint8Array(n.data), l = new Array(s.length), u = 0; u < s.length; u++)
                    l[u] = s[u];
        ...
        t.encodePayload = function(e, n, r) {
            ...
            n = null);
            var a = p(e);
            return n && a ? E && !g ? t.encodePayloadAsBlob(e, r) : t.encodePayloadAsArrayBuffer(e, r) : e.length ? void l(e, i, function(e, t) {
                return r(t.join(""))
            }) : r("0:")
        }
        ,
        ...
        t.encodePayloadAsBlob = function(e, n) {
            function r(e, n) {
                t.encodePacket(e, !0, !0, function(e) {
                    ...
                    if (s[a.length] = 255,
                    E) {
                        var l = new E([t.buffer, s.buffer, e]);
                        n(null, l)
                    }
                })
            }
        ...
        !function(i) {
            ...
            function u(e) {
                if (0 == (4294967168 & e))
                    return b(e);
                var t = "";
                return 0 == (4294965248 & e) ? t = b(e >> 6 & 31 | 192) : 0 == (4294901760 & e) ? (t = b(e >> 12 & 15 | 224),
                t += l(e, 6)) : 0 == (4292870144 & e) && (t = b(e >> 18 & 7 | 240),
                t += l(e, 12),
                t += l(e, 6)),
                t += b(63 & e | 128)
            }
            ...
            var v, g, y, b = String.fromCharCode, T = {
                version: "1.0.0",
                encode: c,
                decode: d
            };
...
, function(e, t) {
    !function() {
        ...
        ,
        t.decode = function(e) {
            var t, r, o, i, a, s = .75 * e.length, l = e.length, u = 0;
            "=" === e[e.length - 1] && (s--,
            "=" === e[e.length - 2] && s--);
...
, function(e, t) {
    ...
    for (var i, a = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), s = 64, l = {}, u = 0, c = 0; c < s; c++)
        l[a[c]] = c;
    o.encode = n,
    o.decode = r,
    e.exports = o
}
, [358, 265], [359, 266], 231, function(e, t, n) {
    (function(t) {
        function r() {}
        function o(e) {
            i.call(this, e),
        ...
        o.prototype.doWrite = function(e, t) {
            ...
            var o = this;
            if (!this.form) {
                var i, a = document.createElement("form"), s = document.createElement("textarea"), c = this.iframeId = "eio_iframe_" + this.index;
...
, function(e, t, n) {
    (function(t) {
        ...
        var o, i = n(251), a = n(252), s = n(261), l = n(262), u = n(263), c = n(264)("engine.io-client:websocket"), p = t.WebSocket || t.MozWebSocket;
...
, function(e, t, n) {
    ...
    var o = n(232)
      ...
      , s = n(275)
      , l = n(276)
      , u = n(229)("socket.io-client:socket")
      , c = n(277);
    e.exports = t = r;
    var p = {
        connect: 1,
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        case i.ACTION_STARS:
            ...
            return localStorage.stars = JSON.stringify(n),
            Object.assign({}, e, {
                stars: n,
                replays: [],
                replaysFinished: !1
        ...
        case i.ACTION_RANK:
            ...
            return localStorage.rank = JSON.stringify(o),
            Object.assign({}, e, {
                rank: o
            });
...
, function(e, t, n) {
    ...
    function r(e, t) {
        ...
        case a.ACTION_PLAY_AGAIN:
            return l.changeURL(t.playAgainUrl),
            s.PAGE_MAIN_MENU;
...
, function(e, t, n) {
    "use strict";
    function r(e) {
        return e || (g.playSound("gong.mp3"),
        y.notify("Game Starting!", "The game is about to begin.")),
        {
            type: b
        }
    }
...
, function(e, t, n) {
    ...
    function i() {
        a.mute_sound = !o(),
        logger.log("Sound muted changed to " + o())
    }
    var a = n(285)
      , s = {};
    "undefined" != typeof Audio && (s["gong.mp3"] = new Audio("/gong.mp3"),
    s["ping.mp3"] = new Audio("/ping.mp3"),
    s["ping.mp3"].volume = .5),
    e.exports = {
        playSound: r,
        isMuted: o,
...
, function(e, t) {
    "use strict";
    function n() {
        a = document[o] ? "hidden" : "visible",
        document[o] || (s.forEach(function(e) {
            e()
        }),
        s = [])
    }
...
, function(e, t) {
    ...
    var o;
    "undefined" != typeof window.history && (o = window.history),
    e.exports = {
        changeURL: n,
        removeHash: r
    }
    ...
    function r(e, t) {
        ...
        case i.ACTION_PLAY:
            return l.isCustomGame(t.queue_id) ? Object.assign({}, e, {
                canSpectate: !0,
                playAgainUrl: c.relativeUrlForPrivate(t.queue_id)
        ...
        case i.ACTION_JOIN_TEAM:
            return Object.assign({}, e, {
                playAgainUrl: c.relativeUrlForTeam(t.team_id)
            });
        case o.ACTION_START:
        ...
        case o.ACTION_CLEAN_PINGS:
            if (e.pings && e.pings.length) {
                ...
                if (r = r.filter(function(e) {
                    return Date.now() - e.timestamp <= u.PING_DURATION
                }),
...
, function(e, t) {
    ...
    n.prototype.serialized = function(e, t, r) {
        ...
        for (var l = 0; l < this._map.length; l++)
            s || r[l] & 1 << e ? (o[l + a] = this._map[l],
            o[l + i] = this._armies[l]) : (o[l + a] = this.tileAt(l) === n.TILE_MOUNTAIN ? n.TILE_FOG_OBSTACLE : n.TILE_FOG,
            o[l + i] = 0);
        for (var l = 0; l < t.length; l++) {
            var u = t[l];
            o[u + a] === n.TILE_FOG && (o[u + a] = n.TILE_FOG_OBSTACLE)
        }
        return o
    }
    ,
    ...
    n.prototype.attack = function(e, t, r, o) {
        if (!this.isValidTile(e))
            return logger.error("Attack has invalid start position " + e),
            !1;
        if (!this.isValidTile(t))
            return logger.error("Attack has invalid end position " + t),
            !1;
        if (!this.isAdjacent(e, t))
            return logger.error("Attack for non-adjacent tiles " + e + ", " + t),
            !1;
...
, function(e, t) {
    ...
    var o = "Account_set_supporter"
      , i = "Account_set_username";
    e.exports = {
        ACTION_SET_SUPPORTER: o,
        ACTION_SET_USERNAME: i,
        setIsSupporter: n,
        setUsername: r
    }
}
, function(e, t, n) {
    ...
    function o(e) {
        ...
        w.dispatch(M.prestart()),
        E = new _([t, n],!1,_.types.TUTORIAL),
        E.start(function() {
            E = null,
            ga("send", "event", "Tutorial", "completed"),
            k.completed_tutorial = !0
        }, !0)
    }
    function i() {
        return E && E.type === _.types.TUTORIAL ? void (E.tutorialCityCaptureEnabled = !0) : void console.error("enableTutorialCityCapture() called for invalid localGame", E)
    }
    function a(e) {
        var t = P.deserialize(e);
        if (!t)
            return void w.dispatch(M.invalidReplay());
        var n = 0
          , r = x.getQueryParams()
          , o = parseInt(r.t);
    ...
    function u() {
        w.getState().game.autoPlay && p(),
        N && setTimeout(u, 500 / w.getState().game.autoPlaySpeed)
    }
    function c() {
        N = !1
    }
    function p(e) {
        ...
        if (!E.isOver()) {
            for (; S.moves.length > A && S.moves[A].turn <= E.turn; ) {
                var n = S.moves[A++];
                E.handleAttack(n.index, n.start, n.end, n.is50)
            }
            for (; S.afks.length > C && S.afks[C].turn <= E.turn; ) {
                var r = S.afks[C++]
                  , o = r.index;
                E.deaths.indexOf(E.sockets[o]) >= 0 ? E.tryNeutralizePlayer(o) : (E.deaths.push(E.sockets[o]),
                E.alivePlayers--)
            }
            E.update(!0),
            e || h()
    ...
    function d() {
        var e = Date.now();
        e - O < 250 || (O = e,
        s(S, Math.max(0, E.turn - 20)))
    }
    function f(e) {
        var t = 2 * e;
        t < E.turn ? s(S, Math.max(0, t)) : t > E.turn && m(t - E.turn)
    }
    function m(e) {
        for (var t = 0; t < e; t++)
            p(!0);
    ...
    function y(e, t, n, r) {
        E && E.bufferAttack(E.sockets[0].id, e, t, n, r)
    }
    function b() {
        E.undoMove(E.sockets[0].id)
    }
    function T() {
...
, function(e, t, n) {
    ...
    function r(e, t, n, o, i, a) {
        if (e) {
            ...
            if (!o) {
                ...
                this.replay = new s(this)
            }
        }
    }
    function o(e, t, n) {
        return t = parseFloat(t),
        isNaN(t) && (t = l.DEFAULT_MAP_SIZE_OPTION),
        t = Math.max(0, Math.min(t, 1)),
        t < .5 ? e + (t - .5) * (3 + n / 2) : e + 2 * (t - .5) * (2 + n)
    }
    function i(e, t) {
        return e - t
    }
    ...
    r.createFromReplay = function(e) {
        var t = e.generals.map(function(t, n) {
          ...
          , n = s.options(e.version)
          , o = new r(t,!1,r.types.REPLAY,!0,n,e.teams);
        o.cities = [],
        o.generals = [],
        o.map = new a(e.mapWidth,e.mapHeight,e.teams);
        for (var i = 0; i < e.mountains.length; i++)
            o.addMountain(e.mountains[i]);
        for (var i = 0; i < e.cities.length; i++)
            o.addCity(e.cities[i], e.cityArmies[i]);
        for (var i = 0; i < e.generals.length; i++)
            o.addGeneral(e.generals[i]);
        return o
    }
    ,
    r.prototype.tryInitializeGame = function(e) {
        if (this.type === r.types.TUTORIAL)
            ...
            !0;
        var t = 16 + e.length
          , n = t + Math.pow(Math.random(), 2) * (4 + e.length / 2)
          , i = t + Math.pow(Math.random(), 2) * (4 + e.length / 2)
          , s = l.MIN_GENERAL_SPACING * (1.8 - .1 * e.length);
        if (this.options && this.options.hasOwnProperty("width") && (n = o(n, this.options.width, e.length)),
        this.options && this.options.hasOwnProperty("height") && (i = o(i, this.options.height, e.length)),
        n = Math.round(n),
        i = Math.round(i),
        n < 1 || i < 1)
            return !1;
        this.map = new a(n,i,this.teams);
        var c = this.map.size();
        if (this.generals = [],
        this.teams && u.hasDuplicate(this.teams)) {
            for (var p, h = 0; ; ) {
                ...
                for (var d = 0; d < e.length; d++)
                    p.push(Math.floor(Math.random() * c));
                for (var f = !1, m = p.map(function() {
                    return 1 / 0
                }), d = 0; d < p.length; d++) {
                    for (var v = 0; v < d; v++)
                        if (this.teams[d] === this.teams[v]) {
                            var g = this.map.distance(p[d], p[v]);
                            if (g < l.MIN_ALLY_SPACING) {
                                f = !0;
                                break
                            }
                            m[d] = Math.min(g, m[d]),
                ...
                for (var d = 0; d < m.length; d++)
                    if (m[d] < 1 / 0 && m[d] > l.MAX_ALLY_SPACING) {
                        f = !0;
                        break
                    }
                if (!f)
            ...
            for (var d = 0; d < e.length; d++) {
                for (var y, b = !1, h = 0; !b; ) {
                    ...
                    for (var v = 0; v < this.generals.length; v++)
                        if (this.map.distance(this.generals[v], y) <= s) {
                            b = !1;
                            break
                        }
                }
        ...
        var T = 5 + e.length * (2 + Math.random());
        if (this.options && this.options.hasOwnProperty("city_density")) {
            var E = parseFloat(this.options.city_density);
            isNaN(E) && (E = l.DEFAULT_CITY_DENSITY_OPTION),
            T *= 2 * E
        }
        this.cities = [];
        for (var d = 0; d < T; d++) {
            var S = Math.floor(Math.random() * c);
            if (this.hasCityOrGeneral(S))
                d--;
            else {
                var A = l.MIN_CITY_ARMY
                  , C = l.MAX_CITY_ARMY;
                this.addCity(S, Math.round(A + Math.random() * (C - A)))
            }
        }
        var _ = c * (.2 + .08 * Math.random());
        if (this.options && this.options.hasOwnProperty("mountain_density")) {
            var E = parseFloat(this.options.mountain_density);
            isNaN(E) && (E = l.DEFAULT_MOUNTAIN_DENSITY_OPTION),
            _ *= E < .5 ? 2 * E : E + .5
        }
        for (var d = 0; d < _; d++) {
            var S = Math.floor(Math.random() * c);
            this.hasCityOrGeneral(S) ? d-- : this.addMountain(S)
        }
        return !0
    }
    ,
    ...
    r.prototype.validateGame = function() {
        ...
        for (var e = 0; e < this.generals.length; e++)
            for (var t = 0; t < e; t++)
                if ((!this.teams || this.teams[e] !== this.teams[t]) && this.map.distance(this.generals[e], this.generals[t]) <= l.MIN_GENERAL_SPACING)
                    return !1;
        if (u.hasDuplicate(this.cities.concat(this.generals)))
            return logger.error("General/City spawn overlap!", this.generals.concat(this.cities).sort()),
            !1;
        if (this.type !== r.types.CUSTOM) {
            for (var n = this.generals.map(function() {
                return 0
            }), e = 0; e < this.cities.length; e++)
                for (var t = 0; t < this.generals.length; t++)
                    this.map.distance(this.cities[e], this.generals[t]) <= l.CLOSE_CITY_DISTANCE && n[t]++;
            if (n = n.sort(i),
            n[0] < 1)
                return !1
        }
        for (var e = 1; e < this.generals.length; e++)
            for (var t = 0; t < e; t++)
                if (!this.isReachable(this.generals[e], this.generals[t]))
                    return !1;
        return !0
    }
    ,
    r.prototype.isReachable = function(e, t) {
        var n = this.map;
        if (n.tileAt(e) === a.TILE_MOUNTAIN || n.tileAt(t) === a.TILE_MOUNTAIN)
            return !1;
        var r = []
          , o = [e];
        r[e] = !0;
        for (var i = this, s = function(e, s) {
            var l = n.indexFrom(e, s);
            e >= 0 && e < n.height && s >= 0 && s < n.width && (n.tileAt(l) === a.TILE_EMPTY || l === t) && i.cities.indexOf(l) < 0 && !r[l] && (r[l] = !0,
            o.push(l))
        }; o.length; ) {
            var l = o.shift();
            if (l === t)
                return !0;
            var u = Math.floor(l / n.width)
              , c = Math.floor(l % n.width);
            s(u - 1, c),
            s(u + 1, c),
            s(u, c - 1),
            s(u, c + 1)
    ...
    r.prototype.start = function(e, t) {
        ...
        setTimeout(function() {
            ...
            if (n.sockets.forEach(function(e, r) {
                e.emit("game_start", {
                    playerIndex: r,
                    replay_id: n.replay.id,
                    chat_room: n.chat_room,
                    team_chat_room: u.hasDuplicate(n.teams) ? u.chatRoomForTeam(n, n.teams[r]) : void 0,
                    usernames: t,
                    teams: n.teams
                })
            }),
            n.update())
                return void e();
            var r = 500;
            if (n.options && n.options.hasOwnProperty("game_speed")) {
                var o = parseFloat(n.options.game_speed);
                isNaN(o) && (o = 1),
                o = Math.max(.25, Math.min(4, o)),
                r /= o
            }
            n.setIntervalReturn = setInterval(function() {
                if (n.update()) {
                    clearInterval(n.setIntervalReturn),
                    e();
    ...
    r.prototype.update = function(e) {
        ...
        if (this.turn++,
        this.turn % l.RECRUIT_RATE === 0) {
            for (var n = 0; n < this.generals.length; n++)
                this.map.incrementArmyAt(this.generals[n]);
            for (var n = 0; n < this.cities.length; n++)
                (this.map.tileAt(this.cities[n]) >= 0 || this.map.armyAt(this.cities[n]) < l.MIN_CITY_ARMY) && this.map.incrementArmyAt(this.cities[n])
        }
        if (this.turn % l.FARM_RATE === 0)
        ...
        if (!e) {
            ...
            if (s) {
                ...
                if (!c) {
                    var p = s.reduce(function(e, t, n) {
                        return n === s.length - 1 ? e + t.gio_username : e + t.gio_username + ", "
                    }, "");
    ...
    r.prototype.sendGameUpdate = function(e, t, n, o) {
        if (!(this.leftSockets.indexOf(n) >= 0)) {
            ...
            var i = this.type === r.types.CUSTOM && this.deaths.indexOf(n) >= 0;
            e.map = this.map.serialized(i ? -1 : o, this.cities, t);
            var s = function(e) {
                return i || t[e] & 1 << o
            }
              , l = function(e) {
                return i || t[e] & 1 << o ? e : -1
            };
            e.cities = this.cities.filter(s),
            e.generals = this.generals.map(l),
            e.map_diff = a.delta(n.last_map, e.map),
            n.last_map = e.map,
            delete e.map,
            e.cities_diff = a.delta(n.last_cities, e.cities),
    ...
    r.prototype.bufferAttack = function(e, t, n, r, o) {
        ...
        return i < 0 ? void logger.error("Client Input for socket_id not in game: " + e) : void this.inputBuffer[i].push([t, n, r, o])
    }
    ,
    r.prototype.handleAttack = function(e, t, n, o, i) {
        if (this.attackIndices[e] = Math.max(this.attackIndices[e], i),
        this.map.tileAt(t) !== e)
            return !1;
        if (this.type === r.types.TUTORIAL && this.cities.indexOf(n) >= 0 && !this.tutorialCityCaptureEnabled)
            return !1;
        ...
        var l = this.map.tileAt(n)
          , u = this.generals.indexOf(n);
        if (l !== a && u >= 0) {
            this.map.replaceAll(a, l, .5);
            var h = this.sockets[a];
            this.deaths.indexOf(h) < 0 && (this.deaths.push(h),
            this.alivePlayers--,
            h.emit("game_lost", {
                killer: l
            })),
            ...
            c || io.to(this.chat_room).emit("chat_message", this.chat_room, {
                text: this.sockets[l].gio_username + " captured " + this.sockets[u].gio_username + "."
            })
        }
    }
    ,
    r.prototype.handlePingTile = function(e, t) {
        if (this.teams) {
            ...
            if (n < 0)
                return void logger.error("Ping for socket_id not in game: " + e);
    ...
    r.prototype.undoMove = function(e) {
        ...
        return t < 0 ? void logger.error("Client Input for socket_id not in game: " + e) : void (this.inputBuffer[t].length > 0 && (this.inputBuffer[t] = this.inputBuffer[t].slice(0, -1)))
    }
    ,
    r.prototype.clearMoves = function(e) {
        var t = this.indexOfSocketID(e);
        return t < 0 ? void logger.error("Client Input for socket_id not in game: " + e) : void (this.inputBuffer[t] = [])
    }
    ,
    r.prototype.handleQuit = function(e) {
        var t = this.indexOfSocketID(e);
        if (t < 0)
            return void logger.error("Trying to handleQuit() for socket not in game.");
    ...
    r.prototype.tryNeutralizePlayer = function(e) {
        ...
        var n = this.aliveTeammate(e)
          , r = Number.isInteger(n) ? n : a.TILE_EMPTY;
    ...
    (function(t) {
        ...
        function r(e) {
            if (e) {
                ...
                for (var t = 0; t < e.map.size(); t++)
                    e.map.tileAt(t) === l.TILE_MOUNTAIN && this.mountains.push(t);
        ...
        r.prototype.serialize = function() {
            var e = this.moves.map(o)
              , n = this.afks.map(a);
            return new t(u.compressToUint8Array(JSON.stringify([p, this.id, this.mapWidth, this.mapHeight, this.usernames, this.stars, this.cities, this.cityArmies, this.generals, this.mountains, e, n, this.teams])))
        }
        ,
        r.deserialize = function(e) {
            try {
                var t = JSON.parse(u.decompressFromUint8Array(new Uint8Array(e)))
            } catch (e) {
                return
            }
            if (t) {
...
, function(e, t, n) {
    (function(e, r) {
        ...
        function T(t, n, r, o, i) {
            ...
            e.isBuffer(n))
                return 0 === n.length ? -1 : E(t, n, r, o, i);
            if ("number" == typeof n)
                return n &= 255,
                e.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(t, n, r) : Uint8Array.prototype.lastIndexOf.call(t, n, r) : E(t, [n], r, o, i);
        ...
        function k(e, t, n) {
            ...
            for (var r = [], o = t; o < n; ) {
                ...
                if (o + s <= n) {
                    ...
                    case 2:
                        l = e[o + 1],
                        128 === (192 & l) && (p = (31 & i) << 6 | 63 & l,
                        p > 127 && (a = p));
                        break;
                    case 3:
                        l = e[o + 1],
                        u = e[o + 2],
                        128 === (192 & l) && 128 === (192 & u) && (p = (15 & i) << 12 | (63 & l) << 6 | 63 & u,
                    ...
                    case 4:
                        ...
                        u = e[o + 2],
                        c = e[o + 3],
                        128 === (192 & l) && 128 === (192 & u) && 128 === (192 & c) && (p = (15 & i) << 18 | (63 & l) << 12 | (63 & u) << 6 | 63 & c,
        ...
        e.prototype.compare = function(t, n, r, o, i) {
            ...
            this === t)
                return 0;
            for (var a = i - o, s = r - n, l = Math.min(a, s), u = this.slice(o, i), c = t.slice(n, r), p = 0; p < l; ++p)
                if (u[p] !== c[p]) {
                    a = u[p],
                    s = c[p];
                    break
...
, function(e, t) {
    ...
    function o(e) {
        ...
        s[p++] = 255 & i) : 1 === a && (i = u[e.charCodeAt(t)] << 10 | u[e.charCodeAt(t + 1)] << 4 | u[e.charCodeAt(t + 2)] >> 2,
        s[p++] = i >> 8 & 255,
        s[p++] = 255 & i),
        s
    }
    ...
    function s(e) {
        for (var t, n = e.length, r = n % 3, o = "", i = [], s = 16383, u = 0, c = n - r; u < c; u += s)
            i.push(a(e, u, u + s > c ? c : u + s));
        return 1 === r ? (t = e[n - 1],
        o += l[t >> 2],
        o += l[t << 4 & 63],
    ...
    t.toByteArray = o,
    t.fromByteArray = s;
    for (var l = [], u = [], c = "undefined" != typeof Uint8Array ? Uint8Array : Array, p = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", h = 0, d = p.length; h < d; ++h)
        l[h] = p[h],
        u[p.charCodeAt(h)] = h;
    u["-".charCodeAt(0)] = 62,
    u["_".charCodeAt(0)] = 63
...
, function(e, t) {
    t.read = function(e, t, n, r, o) {
        var i, a, s = 8 * o - r - 1, l = (1 << s) - 1, u = l >> 1, c = -7, p = n ? o - 1 : 0, h = n ? -1 : 1, d = e[t + p];
        for (p += h,
        i = d & (1 << -c) - 1,
        d >>= -c,
        c += s; c > 0; i = 256 * i + e[t + p],
        p += h,
        c -= 8)
            ;
        for (a = i & (1 << -c) - 1,
        i >>= -c,
        c += r; c > 0; a = 256 * a + e[t + p],
        p += h,
        c -= 8)
            ;
        if (0 === i)
    ...
    t.write = function(e, t, n, r, o, i) {
        var a, s, l, u = 8 * i - o - 1, c = (1 << u) - 1, p = c >> 1, h = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = r ? 0 : i - 1, f = r ? 1 : -1, m = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for (t = Math.abs(t),
        isNaN(t) || t === 1 / 0 ? (s = isNaN(t) ? 1 : 0,
        a = c) : (a = Math.floor(Math.log(t) / Math.LN2),
        t * (l = Math.pow(2, -a)) < 1 && (a--,
        l *= 2),
        t += a + p >= 1 ? h / l : h * Math.pow(2, 1 - p),
        t * l >= 2 && (a++,
        l /= 2),
        a + p >= c ? (s = 0,
        a = c) : a + p >= 1 ? (s = (t * l - 1) * Math.pow(2, o),
        ...
        var t = String.fromCharCode
          ...
          , i = {
            ...
            _compress: function(e, t, n) {
                if (null == e)
                    return "";
                var r, o, i, a = {}, s = {}, l = "", u = "", c = "", p = 2, h = 3, d = 2, f = [], m = 0, v = 0;
                for (i = 0; i < e.length; i += 1)
                    if (l = e.charAt(i),
                    Object.prototype.hasOwnProperty.call(a, l) || (a[l] = h++,
                    s[l] = !0),
                    u = c + l,
            ...
            _decompress: function(e, n, r) {
                var o, i, a, s, l, u, c, p, h = [], d = 4, f = 4, m = 3, v = "", g = [], y = {
                    val: r(0),
                    position: n,
                    index: 1
                };
...
, function(e, t, n) {
    ...
    function a(e) {
        return void 0 !== e && u.characters(e),
        u.shuffled()
    }
    var s, l, u = n(308), c = n(310), p = n(312), h = n(313), d = 1459707606518, f = 6, m = n(314) || 0;
    e.exports = r,
...
, function(e, t, n) {
    ...
    function s() {
        c || o(f);
        for (var e, t = c.split(""), n = [], r = d.nextValue(); t.length > 0; )
            r = d.nextValue(),
...
, function(e, t, n) {
    "use strict";
    var r, o = n(306), i = n(288), a = n(292), s = n(285), l = a.getQueryParams();
    l.user_id && (r = l.user_id,
    logger.log("Setting user_id from query param to " + r),
    s.user_id = r,
    delete s.stars,
    delete s.rank,
    delete s.GIO_LINKED_EMAIL,
    delete s.GIO_CACHED_USERNAME,
    l.email && (s.GIO_LINKED_EMAIL = l.email,
    logger.log("Setting linked email from query param to " + l.email)),
    i.changeURL("/"));
    var u;
    s.user_id ? u = s.user_id : (u = o(),
    s.user_id = u),
    logger.log("WARNING: Do not share your user_id with anyone.  It can be used to impersonate you."),
    logger.log("user_id: " + u),
    e.exports = u
}
, function(e, t, n) {
    "use strict";
...
, function(e, t, n) {
    !function(e, t) {
        e(function() {
            ...
            ,
            function() {
                var e, t, n, o, l, u, c = i.mobileDetectRules;
                for (e in c.props)
                    if (s.call(c.props, e)) {
                        for (t = c.props[e],
                        a(t) || (t = [t]),
                        ...
                        o = 0; o < l; ++o)
                            n = t[o],
                            u = n.indexOf("[VER]"),
                            u >= 0 && (n = n.substring(0, u) + "([\\w._\\+]+)" + n.substring(u + 5)),
                            t[o] = new RegExp(n,"i");
                        c.props[e] = t
                    }
                r(c.oss),
            ...
            i.prepareDetectionCache = function(e, n, r) {
                if (e.mobile === t) {
                    ...
                    void (e.tablet = null)) : void (i.isMobileFallback(n) ? (l = o.isPhoneSized(r),
                    l === t ? (e.mobile = i.FALLBACK_MOBILE,
                    e.tablet = e.phone = null) : l ? (e.mobile = e.phone = i.FALLBACK_PHONE,
...
, function(e, t, n) {
    ...
    var r = n(19)
      , o = r.createClass({
        ...
        render: function() {
            var e = "supporter-tag";
            return this.props.inverted && (e += " inverted"),
            this.props.faded && (e += " faded"),
            r.createElement("span", {
                className: e,
...
, function(e, t, n) {
    ...
    var r = n(19)
      ...
      , i = r.createClass({
        ...
        render: function() {
            var e = this.props.text || "Anonymous"
              , t = "";
            return e.startsWith(o.BOT_TAG) && (t = o.BOT_TAG,
            e = e.substring(o.BOT_TAG.length)),
            t && (t = t.substring(1, t.length - 1)),
    ...
    var r = n(19)
      ...
      , p = r.createClass({
        ...
        handleNotificationPress: function() {
            ...
            i.option(e ? "no" : "yes"),
            this.forceUpdate(),
            logger.log("Notifications changed to", i.option())
        },
        handleMovementPress: function() {
            var e = "enable" === l.old_movement;
            l.old_movement = e ? "disable" : "enable",
            this.forceUpdate(),
            logger.log("Movement changed to", l.old_movement)
        },
        ...
        renderOther: function() {
            ...
            }, u.isMuted() ? "Muted" : "Sound On"));
            return r.createElement("div", null, e)
        },
        render: function() {
            return document.querySelector("body").onkeydown = this.handleKeyPress,
            r.createElement(c, {
                id: "options"
            }, r.createElement("h1", {
                className: "center-horizontal",
...
, function(e, t, n) {
    ...
    var o = n(285)
      , i = function(e, t) {
        return Array.isArray(t) && (a[e].current = t),
        "number" != typeof e && isNaN(e) ? t ? a[e][t] : e ? a[e].current : a : (e = parseInt(e),
        s[e])
    }
      , a = {
        UP: {
      ...
      , s = r.createClass({
        ...
        render: function() {
            ...
            return r.createElement("div", {
                ...
                className: "small inverted" + (this.state.linkEmail ? "" : " disabled"),
                ...
                className: "small inverted" + (this.state.recoverEmail ? "" : " disabled"),
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        var r = e.split("@")
          ...
          , i = r.join("@")
          , s = o.toLowerCase();
        if ("gmail.com" !== s && "googlemail.com" !== s || (i = i.replace(/\./g, "").toLowerCase()),
        !(0,
        c.default)(i, {
            max: 64
        }) || !(0,
        ...
        h.default)(o, {
            ...
            return !1;
        if ('"' === i[0])
            return i = i.slice(1, i.length - 1),
            t.allow_utf8_local_part ? y.test(i) : v.test(i);
        for (var u = t.allow_utf8_local_part ? g : m, p = i.split("."), b = 0; b < p.length; b++)
            if (!u.test(p[b]))
                return !1;
        return !0
    }
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        var n = void 0
          , r = void 0;
        "object" === ("undefined" == typeof t ? "undefined" : i(t)) ? (n = t.min || 0,
        r = t.max) : (n = arguments[1],
        r = arguments[2]);
...
, function(e, t, n) {
    ...
    function o(e, t) {
        ...
        if (t.require_tld) {
            var r = n.pop();
            if (!n.length || !/^([a-z\u00a1-\uffff]{2,}|xn[a-z0-9-]{2,})$/i.test(r))
                return !1
        }
    ...
    var r = n(19)
      ...
      , u = r.createClass({
        ...
        onUsernameChange: function(e) {
            var t = e.target.value.substring(0, i.MAX_USERNAME_LENGTH);
            this.setState({
                username: t
            })
        },
        onSetUsername: function() {
            ...
            if (e) {
                ...
                var t = this;
                this.props.setUsername(e, function(n) {
                    t.setState({
                        err_string: n,
                        loading: !1
                    }),
                    n || (a.GIO_CACHED_USERNAME = e,
                    l.dispatch(s.setUsername(e)),
                    t.props.close())
                })
            }
        },
        render: function() {
            return r.createElement(o, {
                ...
                className: "bold"
            }, "Choose your username carefully."), this.props.is_supporter ? r.createElement("p", null, "You can only change your username while you are a Supporter.", r.createElement("br", null), r.createElement("a", {
                className: "dark",
                href: "/support",
                target: "_blank"
            }, "Check the Supporter page"), " to find out when your Supporter status ends.") : r.createElement("p", null, "Once you choose it, you won't be able to change it unless you are a ", r.createElement("a", {
                className: "dark",
                href: "/support",
                target: "_blank"
            }, "Supporter"), "."), r.createElement("input", {
                type: "text",
                placeholder: "Anonymous",
                value: this.state.username,
                onChange: this.onUsernameChange
            }), this.state.loading ? r.createElement("p", null, "Loading...") : r.createElement("div", null, r.createElement("button", {
                className: "small inverted" + (this.state.username ? "" : " disabled"),
                onClick: this.onSetUsername,
                style: {
                    margin: "0 0 5px 0"
                }
            }, "Set Username"), this.state.err_string ? r.createElement("p", {
                style: {
                    backgroundColor: "rgba(255, 0, 0, 0.2)",
                    padding: "5px"
                }
            }, this.state.err_string) : null))
        }
    });
    e.exports = u
}
    ...
    var r = n(19)
      ...
      , h = r.createClass({
        ...
        render: function() {
            ...
            }, "You are:"), this.props.isTeamQueue || n ? null : r.createElement(c, {
                playerIndex: this.props.playerIndex
            }), this.props.prestart ? null : r.createElement("p", {
                className: "queue-gong-message"
            }, "We'll play a gong sound when the game starts. Turn your volume up!")), this.props.prestart || n || this.props.isTeamQueue || o || !(this.props.numPlayers > 1) ? null : r.createElement(u, null), this.props.prestart ? null : r.createElement("button", {
                className: "small",
...
, function(e, t, n) {
    "use strict";
    for (var r = n(19), o = n(194), i = n(281), a = n(343), s = n(225), l = n(17), u = n(192), c = n(288), p = n(346), h = n(328), d = n(344), f = n(332), m = n(348), v = n(349), g = [], y = 0; y < l.PLAYER_CAP; y++)
        g.push(y + 1);
    var b = 0
      , T = 1
      , E = 2
      , S = 3
      , A = [.25, .5, .75, 1, 1.5, 2, 3, 4]
      , C = r.createClass({
        displayName: "CustomQueue",
        getInitialState: function() {
            return {
                page: b,
                width: l.DEFAULT_MAP_SIZE_OPTION,
                height: l.DEFAULT_MAP_SIZE_OPTION,
                city_density: l.DEFAULT_CITY_DENSITY_OPTION,
                mountain_density: l.DEFAULT_MOUNTAIN_DENSITY_OPTION,
                game_speed: 1
            }
        },
        componentDidMount: function() {
            c.changeURL("/games/" + encodeURIComponent(this.props.queue_id)),
            window.addEventListener("keydown", this.onKeyDown);
            var e = this;
            this.teamOnClicks = g.map(function(t) {
        ...
        componentWillReceiveProps: function(e) {
            this.props.options !== e.options && this.setState(e.options)
        },
        onKeyDown: function(e) {
            f("CHAT").indexOf(e.keyCode) !== -1 && (document.getElementById("chatroom-input").focus(),
            e.preventDefault(),
            e.stopPropagation())
        },
        joinTeam: function(e) {
        ...
        renderTeams: function() {
            if (!this.props.teams || !this.props.usernames)
                return null;
            for (var e = [], t = 0; t < l.PLAYER_CAP; t++)
                e.push([]);
        ...
        onMapWidthChange: function(e) {
            this.setState({
                width: e.target.value
            }),
            this.setWidthOption(e.target.value)
        },
        onMapHeightChange: function(e) {
            this.setState({
                height: e.target.value
            }),
            this.setHeightOption(e.target.value)
        },
        setWidthOption: v(function(e) {
            s.setCustomOptions(this.props.queue_id, {
                width: e
            })
        }, 500),
        setHeightOption: v(function(e) {
            s.setCustomOptions(this.props.queue_id, {
                height: e
            })
        }, 500),
        onCityDensityChange: function(e) {
            this.setState({
                city_density: e.target.value
            }),
            this.setCityDensityOption(e.target.value)
        },
        onMountainDensityChange: function(e) {
            this.setState({
                mountain_density: e.target.value
            }),
            this.setMountainDensityOption(e.target.value)
        },
        setCityDensityOption: v(function(e) {
            s.setCustomOptions(this.props.queue_id, {
                city_density: e
            })
        }, 500),
        setMountainDensityOption: v(function(e) {
            s.setCustomOptions(this.props.queue_id, {
                mountain_density: e
            })
        }, 500),
        setGameSpeed: function(e) {
            e !== this.state.game_speed && (this.setState({
                game_speed: e
            }),
            s.setCustomOptions(this.props.queue_id, {
                game_speed: e
        ...
        render: function() {
            var e = u.chatRoomForCustomGame(this.props.queue_id)
              , t = this
              , n = A.map(function(e) {
                return t.setGameSpeed.bind(t, e)
            });
            return r.createElement("div", {
                ...
                tab_id: "customizations",
                selectedTab: this.state.page,
                onClicks: [this.setPage.bind(this, b), this.setPage.bind(this, T), this.setPage.bind(this, E), this.setPage.bind(this, S)],
                titles: ["Team", "Map", "Obstacles", "Game"]
            })), this.props.prestart || this.state.page !== b ? null : r.createElement("div", {
                className: "custom-queue-page-container"
            }, r.createElement("h3", {
                style: {
                    margin: 0
                }
                ...
                titles: g
            }), r.createElement("br", null), this.renderTeams()), this.props.prestart || this.state.page !== T ? null : r.createElement("div", {
                className: "custom-queue-page-container"
            }, r.createElement("h3", {
                style: {
                    margin: "0 0 3px 0"
                }
            }, "Map Width:"), r.createElement(m, {
            ...
            }, "Map Height:"), r.createElement(m, {
                value: this.state.height,
                minText: "small",
                maxText: "large",
                onChange: this.onMapHeightChange
            })), this.props.prestart || this.state.page !== E ? null : r.createElement("div", {
                className: "custom-queue-page-container"
            }, r.createElement("h3", {
                style: {
                    margin: "0 0 3px 0"
                }
            }, "City Density:"), r.createElement(m, {
                value: this.state.city_density,
                minText: "low",
                maxText: "high",
                onChange: this.onCityDensityChange
            }), r.createElement("h3", {
                style: {
                    margin: "15px 0 3px 0"
                }
            }, "Mountain Density:"), r.createElement(m, {
                value: this.state.mountain_density,
                minText: "low",
                maxText: "high",
                onChange: this.onMountainDensityChange
            })), this.props.prestart || this.state.page !== S ? null : r.createElement("div", {
                className: "custom-queue-page-container"
            }, r.createElement("h3", {
                style: {
                    margin: "0"
                }
            }, "Game Speed:"), r.createElement(h, {
                tab_id: "game-speed",
                selectedTab: A.indexOf(this.state.game_speed),
                onClicks: n,
                titles: A.map(function(e) {
                    return e + "x"
                })
                ...
                className: "queue-gong-message"
            }, "We'll play a gong sound when the game starts. Turn your volume up!")), !this.props.prestart && this.props.numPlayers > 1 ? r.createElement(a, null) : null, this.props.prestart ? null : r.createElement("button", {
                className: "small",
                onClick: this.props.onCancelClicked.bind(this)
        ...
        handleKeyPress: function(e) {
            ...
            if (13 === t)
                if (this.state.currentMessage) {
                    ...
                    i.sendChatMessage(this.props.useTeamChat ? n || r : r, this.state.currentMessage, this.props.useTeamChat && n ? a : ""),
                    this.setState({
                        currentMessage: ""
                    })
                } else
...
, function(e, t, n) {
    ...
    var r = n(19)
      , o = r.createClass({
        displayName: "Slider",
        render: function() {
            var e = Number.isFinite(this.props.min) ? this.props.min : 0
              , t = Number.isFinite(this.props.max) ? this.props.max : 1
              , n = Number.isFinite(this.props.step) ? this.props.step : .01
              , o = this.props.value;
            o = e + n * Math.round((o - e) / n),
            o = Math.round(100 * o) / 100;
            var i = this.props.valueText;
            return i || (i = o,
            1 === parseFloat(this.props.value) && 0 === e && 1 === t ? i = "1.0" : parseFloat(this.props.value) < .01 && 0 === e && 1 === t && (i = "0.0")),
            r.createElement("div", {
                ...
                className: "center-horizontal slider-value"
            }, i), r.createElement("p", {
                className: "slider-min"
            }, this.props.minText), r.createElement("p", {
...
, function(e, t, n) {
    ...
    e.exports = function(e, t, n) {
        function o() {
            var c = r() - l;
            c < t && c > 0 ? i = setTimeout(o, t - c) : (i = null,
            n || (u = e.apply(s, a),
            i || (s = a = null)))
        }
        var i, a, s, l, u;
      ...
      , y = r.createClass({
        ...
        render: function() {
            ...
            return r.createElement("div", {
                ...
                useTeamChat: u.hasDuplicate(this.props.teams) && this.state.isTeamChat
            })), r.createElement(v, {
      ...
      , S = o.createClass({
        ...
        getInitialState: function() {
            return {
                ...
                attackIndex: 1,
                queuedAttacks: [],
                zoom: p ? this.props.isReplay ? T : b : y,
                wheel: 0
            }
        },
        ...
        onTileClick: function(e, t) {
            ...
            if (!(e < 0 || t < 0 || e >= n.height || t >= n.width)) {
                ...
                else if (this.state.selectedIndex === o)
        ...
        onTileMouseDown: function(e, t, n, r) {
            var o = r.nativeEvent ? r.nativeEvent.which : r.which;
            o === v ? this.setState({
                pingCoordinates: {
                    row: e,
                    col: t
        ...
        onMouseUp: function(e) {
            this.state.tileCoordinates ? this.onTileClick(this.state.tileCoordinates.row, this.state.tileCoordinates.col) : this.state.pingCoordinates && !this.props.isReplay && d.hasDuplicate(this.props.teams) && this.pingTile(this.props.map.indexFrom(this.state.pingCoordinates.row, this.state.pingCoordinates.col)),
            this.setState({
        ...
        render: function() {
            ...
            for (var u = [], c = 0; c < r; c++) {
                for (var p = [], d = 0; d < t.width; d++) {
                    var f = t.indexFrom(c, d)
                      , m = t.tileAt(f)
                      , v = m === n
                      , g = f === this.props.selectedIndex
                      , y = this.props.selectedIndex >= 0 && t.isAdjacent(this.props.selectedIndex, f) && m !== l.TILE_MOUNTAIN
                      , b = this.props.inPingMode || v;
                    p.push(o.createElement(a, {
                        row: c,
                        col: d,
                        key: c + "tile" + d,
                        number: t.armyAt(t.indexFrom(c, d)),
                        tile: m,
                        isSelectable: b,
                        isSelected: g,
                        isSelected50: g && this.props.selectedIs50,
                        isAttackable: y,
    ...
    var r = n(19)
      ...
      , s = r.createClass({
        ...
        onMouseDown: function(e) {
            this.props.onMouseDown(this.props.row, this.props.col, this.props.isSelectable || this.props.isAttackable, e)
        },
        componentDidMount: function() {
            ...
            e.addEventListener("touchmove", this.props.onMouseMove, {
                passive: !1
            }),
            e.addEventListener("touchend", this.props.onMouseUp, {
                passive: !1
            })
        },
        componentWillUnmount: function() {
            var e = o.findDOMNode(this);
            e.removeEventListener("touchstart", this.onMouseDown),
            e.removeEventListener("touchmove", this.props.onMouseMove),
            e.removeEventListener("touchend", this.props.onMouseUp)
        },
        render: function() {
            var e = "enable" == localStorage.old_movement
              , t = this.props.tile === a.TILE_FOG || this.props.tile === a.TILE_FOG_OBSTACLE
              , n = this.props.tile === a.TILE_MOUNTAIN
              , o = this.props.tile === a.TILE_FOG_OBSTACLE
              , s = i.PLAYER_COLORS[this.props.tile] || "";
            return this.props.isSelected50 && (s += " selected50"),
            this.props.isGeneral ? s += " general" : this.props.isCity ? s += " city" : this.props.number > 0 && (s += " neutral"),
            e && !this.props.isPinged && this.props.isSelected && (s += " selected"),
            t && (s = "fog"),
            o && (s = "fog obstacle"),
            e || !this.props.isPinged && this.props.isSelected && (s += " selected"),
            this.props.isAttackable && (s += " attackable"),
            n ? s = "mountain" : (this.props.isSelectable && (s += " selectable"),
            this.props.isPinged && (s += " selected")),
            this.props.zoomClass && (s += " " + this.props.zoomClass),
            r.createElement("td", {
                className: s,
                onMouseDown: this.onMouseDown,
                onMouseMove: this.props.onMouseMove,
    ...
    var r = n(291)
      ...
      , c = o.createClass({
        ...
        onWASD: function() {
            ...
            p.onDrag = this.onDrag
        },
        componentWillReceiveProps: function(e) {
            this.props.state === r.STATE_MOVE && e.scores[e.playerIndex].tiles > 1 ? l ? (this.moveToState(r.STATE_DRAG),
            p.onDrag = this.onDrag) : (this.moveToState(r.STATE_WASD),
            p.onWASD = this.onWASD) : this.props.state === r.STATE_CITY && e.numCities > 0 ? this.moveToState(r.STATE_WIN) : this.props.state === r.STATE_WIN && e.playerDidWin === !0 && this.moveToState(r.STATE_WON)
        },
        render: function() {
            var e = null;
